...
CHAT_SYSTEM_TMPL = (
    ...
    "inside their own sentences. Include a word even if it already appears in WORD BOOK — re-asking is a signal and "
    "the system just attaches this exchange to the existing entry. When nothing was asked about, use []. Examples — learner: \"big, huge, enormous 有什么"
